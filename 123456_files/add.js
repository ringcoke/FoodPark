...
Zone[2] = new Array("仁愛區","信義區","中正區","中山區","安樂區",
	"暖暖區","七堵區");
// for "臺北縣"
Zone[3] = new Array("萬里鄉","金山鄉","板橋市","汐止鎮","深坑鄉","石碇鄉","瑞芳鎮",
...
Zone[9] = new Array("中區","東區","南區","西區","北區","北屯區",
	"西屯區","南屯區");
// for "臺中縣"
Zone[10] = new Array("太平市","大里市","霧峰鄉","烏日鄉","豐原市","后里鄉","石岡鄉",
...
"義竹鄉","布袋鎮");
// for "雲林縣"
Zone[15] = new Array("斗南市","大埤鄉","虎尾鎮","土庫鎮","褒忠鄉","東勢鄉","臺西鄉",
...
function ResetAll()
{
	initCounty(form1.City);
	initZone(form1.City, form1.Canton, form1.Zip);
}
