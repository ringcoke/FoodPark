...
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link type="text/css" rel="stylesheet" href="css"><style type="text/css">.gm-style .gm-style-cc span,.gm-style .gm-style-cc a,.gm-style .gm-style-mtc div{font-size:10px}</style><style type="text/css">@media print {  .gm-style .gmnoprint, .gmnoprint {    display:none  }}@media screen {  .gm-style .gmnoscreen, .gmnoscreen {    display:none  }}</style><style type="text/css">.gm-style{font-family:Roboto,Arial,sans-serif;font-size:11px;font-weight:400;text-decoration:none}.gm-style img{max-width:none}</style>
        ...
        <link rel="shortlink" href="saved_resource.html">
        <script type="text/javascript">
            var _gaq = _gaq || [];
                ...
                <div class="header-topbar">
                    <div class="container">                                               
                        <div class="header-topbar-left">
                            <ol class="breadcrumb">
                                <li><a href="saved_resource.html">Home</a></li>        
                                <li>Food Park</li>
                            </ol>
                        </div>
                        <!-- /.header-topbar-left -->
                    ...
                    <div class="header-top">
                        <div class="container">
                            <div class="navbar-header"><!--標題圖片-->
                                ...
                                <a class="navbar-brand" href="saved_resource.html">
                                        ...
                                        <ul class="dropdown-menu sub-menu">
                                            <li id="a00" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-512">
                                                ...
                                                <ul class="dropdown-menu sub-menu">
                                                    ...
                                                    <li id="a17" class="menu-item menu-item-type-taxonomy menu-item-object-locations menu-item-558">
                                                        <a href="saved_resource.html">
                                                            <span class="cr">37夜市</span></a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li id="f00" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-568">
                                                ...
                                                <ul class="dropdown-menu sub-menu">
                                                    ...
                                                    <li id="f09" class="menu-item menu-item-type-taxonomy menu-item-object-locations menu-item-570">
                                                        <a href="saved_resource.html">
                                                            <span class="cr">光明街夜市</span></a>
                                                    </li>
                                                    ...
                                                    <li id="f13" class="menu-item menu-item-type-taxonomy menu-item-object-locations menu-item-570">
                                                        <a href="saved_resource.html">
                                                            <span class="cr">枋寮夜市</span></a>
                                                    </li>
                                                </ul>
                                            </li>
                                    ...
                                    <li id="menu-item-564" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-564">
                                        ...
                                        <ul class="dropdown-menu sub-menu">
                                            <li id="menu-item-565" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-565">
                                                <a href="saved_resource.html">
                                                    Art <i class="fa fa-caret-square-o-right"></i></a>
                                                <ul class="dropdown-menu sub-menu">
                                            ...
                                            <li id="menu-item-569" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-569">
                                                ...
                                                <ul class="dropdown-menu sub-menu">
                                                    <li id="menu-item-566" class="menu-item menu-item-type-taxonomy menu-item-object-locations menu-item-566">
                                                        <a href="">
                                                            <span class="cr">可啡</span></a>
                                                    </li>
                                                    <li id="menu-item-567" class="menu-item menu-item-type-taxonomy menu-item-object-locations menu-item-567">
                                                        <a href="http://preview.byaviators.com/theme/realia/location/new-york-city/brooklyn/">
                                                            <span class="cr">美食公園</span></a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li id="menu-item-400" class="menu-item menu-item-type-taxonomy menu-item-object-locations menu-item-400">
                                                <a href="http://preview.byaviators.com/theme/realia/property-slider/">
                                                    <span class="cr">國家戲劇院</span> </a>
                                            </li>
                                            <li id="menu-item-400" class="menu-item menu-item-type-taxonomy menu-item-object-locations menu-item-400">
                                                <a href="http://preview.byaviators.com/theme/realia/property-slider/">
                                                    <span class="cr">國家音樂廳</span> </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li id="menu-item-566" class="menu-item menu-item-type-taxonomy menu-item-object-locations menu-item-566">
                                        <a href="searchpk.html"><span class="cr">臨時找車位</span></a>
                                    </li>
                                    <li id="menu-item-566" class="menu-item menu-item-type-taxonomy menu-item-object-locations menu-item-566">
                                        <a href=""><span class="cr">關於...</span></a>
                                    </li>
                            </div>
                        </div><!-- /.container -->
                                    ...
                                    <div class="property-container">
                                        <div class="property-box">
                                            <div class="property-box-image ">
                                                <a href="http://preview.byaviators.com/theme/realia/properties/south-mervin-boulevard/" class="property-box-image-inner ">
                                            ...
                                            <div class="property-box-content">
                                                <div class="property-box-title">
                                                    <h3><a href="http://preview.byaviators.com/theme/realia/properties/south-mervin-boulevard/">士林夜市</a></h3>
                                                ...
                                                <div class="property-box-body">
                                                    ...
                                                    <div class="property-box-read-more">
                                                        <a href="http://preview.byaviators.com/theme/realia/properties/south-mervin-boulevard/">Read More</a>
