...
DROP TABLE IF EXISTS `post_city`;
...
LOCK TABLES `post_city` WRITE;
/*!40000 ALTER TABLE `post_city` DISABLE KEYS */;
INSERT INTO `post_city` VALUES ('01','台北市','Taipei City'),('02','新北市','New Taipei City');
/*!40000 ALTER TABLE `post_city` ENABLE KEYS */;
UNLOCK TABLES;
